...
export default {
  ...
  data() {
    return {
      code: `<section class="my-8 bg-white border rounded-lg shadow-xl border-gray-50 dark:bg-gray-500 dark:text-white">
<div class="grid grid-cols-1 p-8 lg:grid-cols-2">
  ...
  <div class="">
    <div class="w-full mb-2 lg:w-2/3 md:w-full xl:w-1/2">
