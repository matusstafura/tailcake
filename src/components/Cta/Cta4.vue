...
<div class="items-center lg:flex">
  ...
  <div class="flex flex-wrap">
    <button class="mr-2 flex rounded bg-indigo-600 px-4 py-1 text-[0.95rem] text-white shadow-md hover:bg-indigo-500 dark:hover:bg-blue-500 dark:hover:text-gray-100">
    ...
    <button class="flex rounded bg-indigo-600 px-4 py-1 text-[0.95rem] text-white shadow-md hover:bg-indigo-500 dark:hover:bg-blue-500 dark:hover:text-gray-100">
