  ...
  <div class="grid grid-cols-1 bg-white border border-gray-100 shadow rounded-xl md:grid-cols-3 dark:bg-gray-200">
    <div class="col-span-2 p-8">
      ...
      <ul class="grid grid-cols-1 py-4 mt-4 text-gray-500 gap-y-4 md:grid-cols-2">
        <li class="flex">
          <svg class="p-1 mt-1 mr-2 bg-indigo-500 rounded-xl fill-indigo-100" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"><path d="M20.285 2l-11.285 11.567-5.286-5.011-3.714 3.716 9 8.728 15-15.285z"></path></svg>
    ...
    <div class="flex flex-col p-8 text-center rounded-r-lg bg-slate-50 dark:bg-slate-100">
      ...
      <div>
        <button type="submit" class="px-6 py-2 m-2 text-white bg-indigo-500 rounded-3xl hover:bg-black">
          <span>Get in touch</span>
          <svg fill="#ffffff" class="inline w-3 ml-2 -mt-1 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M7.33 24l-2.83-2.829 9.339-9.175-9.339-9.167 2.83-2.829 12.17 11.996z" /></svg>
        </button>
      </div>
    </div>
  </div>
