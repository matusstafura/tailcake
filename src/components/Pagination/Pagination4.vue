...
<div class="grid grid-cols-1 text-gray-600 xl:grid-cols-2 dark:text-white">
  ...
  <nav class="flex m-auto dark:text-gray-200 xl:m-0">
    ...
    <a href="#" class="px-4 py-2 border border-gray-300 md:mx-2 hover:bg-gray-200">1</a>
    <a href="#" class="px-4 py-2 border border-gray-300 md:mx-2 hover:bg-gray-200">2</a>
    <span class="px-4 py-2 text-white bg-blue-500 border border-gray-300 md:mx-2 dark:bg-gray-400 dark:text-white">3</span>
    <a href="#" class="px-4 py-2 border border-gray-300 md:mx-2 hover:bg-gray-200">4</a>
    <a href="#" class="px-4 py-2 border border-gray-300 md:mx-2 hover:bg-gray-200">5</a>
