...
<div class="flex justify-center">
  <nav class="flex -space-x-px text-gray-500 dark:text-gray-200">
    <a href="#" class="px-2 py-2 border border-gray-300 rounded-l hover:bg-gray-200">
    ...
    <a href="#" class="px-4 py-2 border border-gray-300 hover:bg-gray-200">1</a>
    ...
    <a href="#" class="px-4 py-2 border border-gray-300 hover:bg-gray-200">...</a>
    <a href="#" class="px-4 py-2 border border-gray-300 hover:bg-gray-200">100</a>
    <a href="#" class="px-2 py-2 border border-gray-300 rounded-r hover:bg-gray-200">
      <svg class="w-5 h-4 mt-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
