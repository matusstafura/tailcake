...
<div class="flex gap-x-3">
  <a href="https://www.buymeacoffee.com/matusstafura" target="_blank" class="hover:shadow-lg">
  ...
  <a href="https://github.com/matusstafura/tailcake" class="flex items-center px-6 shadow rounded-2xl hover:shadow-lg dark:bg-gray-500 dark:text-white" target="_blank">
